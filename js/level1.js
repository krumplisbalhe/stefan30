...
const playFreeSki = () => {
	...
	speechP.innerHTML = 'Play 30 seconds without'
	setTimeout(speechBubbleTextChange8, 2000)
}

const speechBubbleTextChange8 = () => {
	speechP.innerHTML = 'loosing and I\'m free!'
	pernille.style.backgroundImage = 'url(../Characters/Pernille/PernilleSmile.png)'
	setTimeout(pernilleStopsSpeaking, 2000)
}
